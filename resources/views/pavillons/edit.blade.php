...
@section('title', 'Modifier pavillon - CMC Pointage')
@section('page-title', 'Modifier pavillon')
@section('breadcrumb', 'CMC Pointage › Pavillons › Modifier')
        ...
        <div class="col-12 col-lg-6">
            <div class="card animate-in">
                <div class="card-body p-4">
                    <h2 class="section-title mb-1">Modifier le pavillon</h2>
                    <p class="section-subtitle mb-4">Mettre à jour les informations</p>

                    <form method="POST" action="{{ route('pavillons.update', $pavillon->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required style="border-radius:.625rem;">
                                <option value="homme" {{ old('type', $pavillon->type) === 'homme' ? 'selected' : '' }}>Homme</option>
                                <option value="femme" {{ old('type', $pavillon->type) === 'femme' ? 'selected' : '' }}>Femme</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" class="form-control @error('nombre_etages') is-invalid @enderror" id="nombre_etages" name="nombre_etages" value="{{ old('nombre_etages', $pavillon->nombre_etages) }}" min="1" max="50" required style="border-radius:.625rem;">
